<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" EnableSessionState="True"  Inherits="register.Home" %>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo" style="color:orangered">BDI GROUP Ltd</h1>

      <nav id="navbar" class="navbar">
        <ul>
         <li>
             <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/manage.aspx"><b>VIEW_EMPLOYEE</b></asp:HyperLink></li>
            <li>
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/salary.aspx"><b>SALARY</b></asp:HyperLink></li>

            <li>
                <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/Task.aspx"><b>TASK </b>  </asp:HyperLink></li> 
            <li>
             <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Messges.aspx"><b>Message_list</b></asp:HyperLink></li><br />
           <li><span>  </span></li> 
           <li style="margin-left:10px">
                <form  runat="server">
                    <asp:Button ID="Button1" runat="server" style="border-radius:10px" Onclick="Button1_Click" Text="LOGOUT" BackColor="Red" ForeColor="White" BorderStyle="None" />
                </form>  </li>
        </ul>
